...
//////////////////////////////////////////////////////////////////////
		...
		var x = xmlDoc.getElementsByTagName("comarca");
			...
			var id = x[25].getAttribute("id");

			var nombre = x[25].getAttribute("nomCOMARCA"); 
            
		  
			var nombreCa = x[25].getAttribute("nomCAPITALCO");
		...
		var xmlDoc = xml.responseXML;
		var seccio = document.getElementsByTagName("section");
		var variable = xmlDoc.getElementsByTagName("prediccio")[25].getElementsByTagName("variable")[0];
		...
		var idsimboltarda = variable.getAttribute("simboltarda").slice(0,-4);
			...
			var variable = xmlDoc.getElementsByTagName("prediccio")[25].getElementsByTagName("variable")[1];
			var idsimbolmati = variable.getAttribute("simbolmati").slice(0,-4);
			var idsimboltarda = variable.getAttribute("simboltarda").slice(0,-4);
